          ...
          <div className="flex flex-wrap mb-24 lg:mb-18 justify-between items-center">
            ...
            <div className="w-full lg:w-auto">
              <div className="flex flex-wrap justify-center items-center md:justify-start -mb-2">
                <a
                  className="inline-block py-4 px-6 mb-2 md:mb-0 w-full md:w-auto md:mr-5 text-lg leading-6 text-coolGray-50 font-medium text-center bg-green-500 hover:bg-green-600 focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 border border-transparent rounded-md shadow-sm"
                  href="#"
                >
                  Open Positions
                </a>
                <a
                  className="inline-block py-4 px-6 w-full md:w-auto text-lg leading-6 font-medium text-center text-coolGray-500 bg-white border border-coolGray-200 hover:border-coolGray-300 focus:ring-2 focus:ring-coolGray-200 focus:ring-opacity-50 rounded-md shadow-sm"
                  href="#"
                >
                  About Us
                </a>
